...
export default function Sidebar({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <aside className="flex flex-col h-full" style={{ background: "rgba(15,23,42,0.95)", borderRight: "1px solid rgba(99,102,241,0.1)" }}>
      ...
      <div className="px-3 py-4 border-t" style={{ borderColor: "rgba(99,102,241,0.1)" }}>
        {session?.user && (
          <div className="px-3 py-3 mb-3 rounded-lg" style={{ background: "rgba(99,102,241,0.08)" }}>
